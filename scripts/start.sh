...
echo "  npm run index                          — index all assets (run FIRST)"
echo "  npm run index:report                   — print asset learning report"
echo "  npm run index:search -- \"dark bg tiktok\" — search indexed assets"
